                ...
                <div class="col-inner">
                    ...
                    <ul class="social list-unstyled list-inline">
                        <li class="list-inline-item facebook animated fadeInUp" data-animation="fadeInUp" style="animation-delay: 1.7s;">
                            <a href="https://www.facebook.com/bcgm3/" target="_blank" title="Facebook" rel="noopener"><i class="fa fa-facebook"></i></a>
                        </li>
                        <li class="list-inline-item twitter animated fadeInUp" data-animation="fadeInUp" style="animation-delay: 1.8s;">
                            <a href="https://twitter.com/bcgm3" target="_blank" title="Twitter" rel="noopener"><i class="fa fa-twitter"></i></a>
                        </li>
                        <li class="list-inline-item instagram animated fadeInUp" data-animation="fadeInUp" style="animation-delay: 1.9s;">
                            <a href="https://www.instagram.com/bencgmiles/" target="_blank" title="Instagram" rel="noopener"><i class="fa fa-instagram"></i></a>
                        </li>
                        <li class="list-inline-item linkedin animated fadeInUp" data-animation="fadeInUp" style="animation-delay: 1.9s;">
                            <a href="https://www.linkedin.com/in/benjaminmiles/" target="_blank" title="linkedIn" rel="noopener"><i class="fa fa-linkedin"></i></a>
                        </li>
                        <li class="list-inline-item codepen animated fadeInUp" data-animation="fadeInUp" style="animation-delay: 2s;">
                            <a href="https://codepen.io/benmiles/" target="_blank" title="CodePen" rel="noopener"><i class="fa fa-codepen"></i></a>
                        </li>
                        <li class="list-inline-item github animated fadeInUp" data-animation="fadeInUp" style="animation-delay: 2.1s;">
                            <a href="https://github.com/ben-miles" target="_blank" title="GitHub" rel="noopener"><i class="fa fa-github"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
